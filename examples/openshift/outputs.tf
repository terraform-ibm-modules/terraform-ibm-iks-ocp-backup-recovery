...
output "brs_private_hostname" {
  ...
  value       = var.create_source_cluster_brs_vpe_gateway && !var.classic_cluster ? "${module.backup_recover_protect_ocp.brs_instance_guid}.private.${local.brs_region}.backup-recovery.cloud.ibm.com" : null
}
