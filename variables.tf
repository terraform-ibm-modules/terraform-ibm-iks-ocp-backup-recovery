...
variable "external_kubeconfig_path" {
  description = "Optional external kubeconfig file path. When provided, the cleanup script will use this kubeconfig instead of the one generated by the module. This is useful when the module is called from examples or other contexts where the kubeconfig is managed externally."
  type        = string
  default     = null
}
