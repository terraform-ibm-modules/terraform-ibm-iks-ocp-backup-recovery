...
| <a name="input_dsc_worker_pool_flavor"></a> [dsc\_worker\_pool\_flavor](#input\_dsc\_worker\_pool\_flavor) | The machine flavor for the Data Source Connector worker pool. `bxf.4x16` (4 vCPU, 16 GB RAM) is available in every IBM Cloud VPC zone. Override for a larger flavor (e.g. `bxf.8x32`). | `string` | `"bxf.4x16"` | no |
