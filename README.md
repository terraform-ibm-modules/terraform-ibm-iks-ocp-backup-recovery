...
| <a name="input_enable_auto_protect"></a> [enable\_auto\_protect](#input\_enable\_auto\_protect) | Set to `true` to enable auto-protect on the registered cluster with the specified protection policy. | `bool` | `true` | no |
