...
| <a name="module_brs_s2s_auth"></a> [brs\_s2s\_auth](#module\_brs\_s2s\_auth) | terraform-ibm-modules/s2s-auth/ibm | 2.3.6 |
| <a name="module_brs_vpe"></a> [brs\_vpe](#module\_brs\_vpe) | terraform-ibm-modules/vpe-gateway/ibm | 5.4.2 |
