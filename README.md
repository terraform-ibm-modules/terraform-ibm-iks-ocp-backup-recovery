...
| <a name="input_brs_connection_id"></a> [brs\_connection\_id](#input\_brs\_connection\_id) | Connection ID of the BRS data-source connection. Provided by the DA or example that owns the BRS instance. | `string` | n/a | yes |
...
| <a name="input_brs_instance_crn"></a> [brs\_instance\_crn](#input\_brs\_instance\_crn) | CRN of the BRS service instance. Provided by the DA or example that owns the BRS instance. | `string` | n/a | yes |
| <a name="input_brs_instance_guid"></a> [brs\_instance\_guid](#input\_brs\_instance\_guid) | GUID of the BRS service instance. Provided by the DA or example that owns the BRS instance. | `string` | n/a | yes |
| <a name="input_brs_instance_private_url"></a> [brs\_instance\_private\_url](#input\_brs\_instance\_private\_url) | Private endpoint URL of the BRS instance (without scheme). Provided by the DA or example that owns the BRS instance. | `string` | n/a | yes |
| <a name="input_brs_instance_public_url"></a> [brs\_instance\_public\_url](#input\_brs\_instance\_public\_url) | Public endpoint URL of the BRS instance (without scheme). Provided by the DA or example that owns the BRS instance. | `string` | n/a | yes |
| <a name="input_brs_registration_token"></a> [brs\_registration\_token](#input\_brs\_registration\_token) | Registration token used to register the DSC with the BRS instance. Provided by the DA or example that owns the BRS instance. | `string` | n/a | yes |
| <a name="input_brs_tenant_id"></a> [brs\_tenant\_id](#input\_brs\_tenant\_id) | Tenant ID of the BRS instance. Provided by the DA or example that owns the BRS instance. | `string` | n/a | yes |
